...
namespace Lib.Validation
{
    ...
    public class LaterDateValidationAttribute : ValidationAttribute
    {
        public override string DefaultMessage => "'{name}' must be a date after '{name2}'.";
        public bool Equal { get; init; }
        public string Name { get; init; }
        public string Format { get; init; }
        public LaterDateValidationAttribute(string name) => Name = name;
